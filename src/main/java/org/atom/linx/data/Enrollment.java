...
public class Enrollment {
    ...
    protected String course_integration_id;
    protected int course_section_id;
    protected String section_integration_id;
    protected String sis_account_id;
    protected String sis_section_id;
    protected String sis_user_id;
    protected String enrollment_state;
    protected boolean limit_privileges_to_course_section;
    protected int sis_import_id;
    protected int root_account_id;
    protected String type;
    protected int user_id;
    protected Object associated_user_id;
    ...
    protected Date last_activity_at;
    protected Date last_attended_at;
    protected int total_activity_time;
    protected String html_url;
    protected Grades grades;
    protected User user;
    protected String override_grade;
    protected double override_score;
    protected String unposted_current_grade;
    protected String unposted_final_grade;
    protected String unposted_current_score;
    protected String unposted_final_score;
    protected boolean has_grading_periods;
    protected boolean totals_for_all_grading_periods_option;
    protected String current_grading_period_title;
    protected int current_grading_period_id;
    protected String current_period_override_grade;
    protected double current_period_override_score;
    protected double current_period_unposted_current_score;
    protected double current_period_unposted_final_score;
    protected String current_period_unposted_current_grade;
    protected String current_period_unposted_final_grade;
