...
public class AccountNotificationManager {
    public static AccountNotification[] listGlobalNotifications(int account_id) {
        return new Gson().fromJson(APIManager.GET("/api/v1/accounts/" + account_id + "/account_notifications", new SearchQuery()), AccountNotification[].class);
    }
    ...
    public static AccountNotification getGlobalNotification(int account_id, int notification_id) {
        return new Gson().fromJson(APIManager.GET("/api/v1/accounts/" + account_id + "/account_notifications/" + notification_id, new SearchQuery()), AccountNotification.class);
    }
