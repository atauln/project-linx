...
public class AssignmentManager {
    ...
    public static Assignment[] listAssignments(int course_id) {
        String r = APIManager.GET("/api/v1/course/" + course_id + "/assignments", new SearchQuery());
        return new Gson().fromJson(r, Assignment[].class);
    }
    public static Assignment[] listAssignments(int course_id, SearchQuery query) {
    ...
    public static Assignment[] listAssignments(int course_id, int assignment_group_id) {
        String r = APIManager.GET("/api/v1/course/" + course_id + "/assignment_groups/" + assignment_group_id + "/assignments", new SearchQuery());
        return new Gson().fromJson(r, Assignment[].class);
    }
    public static Assignment[] listAssignments(int course_id, int assignment_group_id, SearchQuery query) {
    ...
    public static Assignment[] listUserAssignments(int user_id, int course_id) {
        String r = APIManager.GET("/api/v1/users/" + user_id + "/courses/" + course_id + "/assignments", new SearchQuery());
        return new Gson().fromJson(r, Assignment[].class);
    }
    public static Assignment[] listUserAssignments(int user_id, int course_id, SearchQuery query) {
    ...
    public static Assignment getAssignment(int course_id, int assignment_id) {
        String r = APIManager.GET("/api/v1/courses/" + course_id + "/assignments/" + assignment_id, new SearchQuery());
        return new Gson().fromJson(r, Assignment.class);
    }
    public static Assignment getAssignment(int course_id, int assignment_id, SearchQuery query) {
    ...
    public static AssignmentOverride[] listAssignmentOverrides(int course_id, int assignment_id) {
        String r = APIManager.GET("/api/v1/courses/" + course_id + "/assignments/" + assignment_id + "/overrides", new SearchQuery());
    ...
    public static AssignmentOverride getAssignmentOverride(int course_id, int assignment_id, int override_id) {
        String r = APIManager.GET("/api/v1/courses/" + course_id + "/assignments/" + assignment_id + "/overrides/" + override_id, new SearchQuery());
        return new Gson().fromJson(r, AssignmentOverride.class);
    }

    public static JsonObject getRedirectGroupOverride(int group_id, int assignment_id) {
        String r = APIManager.GET("/api/v1/groups/" + group_id + "/assignments/" + assignment_id + "/override", new SearchQuery());
    ...
    public static JsonObject getRedirectSectionOverride(int course_section_id, int assignment_id) {
        String r = APIManager.GET("/api/v1/sections/" + course_section_id + "/assignments/" + assignment_id + "/override", new SearchQuery());
        return new Gson().fromJson(r, JsonObject.class);
    }
    ...
    public static AssignmentOverride[] batchRetrieveOverrides(int course_id) {
        String r = APIManager.GET("/api/v1/courses/" + course_id + "/assignments/overrides", new SearchQuery());
        return new Gson().fromJson(r, AssignmentOverride[].class);
    }
